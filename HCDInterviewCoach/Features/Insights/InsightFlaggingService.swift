...
class InsightFlaggingService: ObservableObject {
    ...
    @Published var lastFlaggedInsight: Insight?

    /// Current flagging status for UI feedback
    @Published var flaggingStatus: FlaggingStatus = .idle
    ...
    /// Subclasses can override this for testing with an in-memory container.
    var modelContext: ModelContext {
        dataManager.mainContext
    }
